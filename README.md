...
- Keep share-card acceptance evidence for generated proof cards, generated mode cards, public proof URLs, and opened X/native share channels.
...
The match board also includes a realtime data health gate that combines the active provider route, last sync freshness, live/configured signal count, evidence rows, and missing enrichment signals before the production radar treats match data as ready.
